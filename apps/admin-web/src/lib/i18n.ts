  ...
  en: {
    translation: {
      ...
      pages: {
        ...
        washJobsList: { title: 'Wash Jobs', jobs: 'Jobs', scheduled: 'Scheduled', status: 'Status', filterByDate: 'Filter by date', allDates: 'All dates', today: 'Today', addWashJob: 'Add wash job', generateTodaysJobs: "Generate today's jobs", client: 'Client', car: 'Car', scheduledAt: 'Scheduled at', noJobsForDate: 'No jobs for this date.', addSuccess: 'Wash job added.', generateSuccess: "Today's jobs generated.", generationReport: "Generated {{created}} new wash job(s) for today. {{skipped}} already had a job and were skipped.", generationReportNone: 'No new jobs to generate. All enrolled clients already have jobs for today.', generationReportOnlySkipped: 'All enrolled clients already have jobs for today ({{skipped}} skipped). No duplicates created.', dismiss: 'Dismiss', comments: 'Comments', commentsAction: 'Comments', addComment: 'Add comment', commentPlaceholder: 'Note for worker...', commentAdded: 'Comment added.', commentUpdated: 'Comment updated.', commentDeleted: 'Comment deleted.', editComment: 'Edit', deleteComment: 'Delete', confirmDeleteComment: 'Delete this comment?', noCommentsYet: 'No comments yet.', addNewComment: 'Add comment', close: 'Close', tableView: 'Table', calendarView: 'Calendar', generateMonthJobs: 'Generate month jobs', generateMonthSuccess: 'Month jobs generated.', generationMonthReport: 'Generated {{created}} job(s) for the month. {{skipped}} already existed.', generationMonthReportNone: 'No new jobs for this month.' },
        washPlansList: { title: 'Wash Plans', plans: 'Plans', name: 'Name', days: 'Days', timesPerWeek: 'Times/Week', location: 'Location', washes: 'Washes', subtitle: 'Use Enrollment to add/remove clients from plans.', addPlan: 'Add plan', editPlan: 'Edit plan', deletePlan: 'Delete', confirmDeletePlan: 'Delete this plan? Enrolled clients will be unlinked.', removeSuccess: 'Plan removed.', createSuccess: 'Plan created.', updateSuccess: 'Plan updated.', noPlans: 'No plans yet.', actions: 'Actions', periodWeeks: 'Period (weeks)', periodWeeksOptional: 'Optional', locationInside: 'Inside', locationOutside: 'Outside', first: 'First', previous: 'Previous', next: 'Next', last: 'Last' },
